    ...
    <div class="tab-pane fade active show" id="breakfast" role="tabpanel" aria-labelledby="breakfast-tab">
        <div class="row">
            ...
            <div class="col-6">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Filet Americain </h4>
                        <p>&euro;10,50</p>
        ...
        <div class="row">
            ...
            <div class="col-6">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Gerookte kipfilet </h4>
                        <p>&euro;10,50</p>
        ...
        <div class="row">
            ...
            <div class="col-6">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Carpaccio </h4>
                        <p>&euro;10,50</p>
            ...
            <div class="col-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p>&euro;14,50</p>
                        <p class="card-text">Truffelburger | meergranen bun | little gem | zoete uien compôte | bacon | “Utregse” Oude Gracht kaas | twister friet | geroosterde paprikasaus</p>
                        <button class="btn btn-primary">Toevoegen aan winkelmand</button>
                    </div>
                </div>
            </div>
